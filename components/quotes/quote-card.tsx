...
export function QuoteCard({
  ...
  const formatQuoteId = (id: string) => {
    // Extract numeric part from UUID or use a hash
    const numericId = Number.parseInt(id.replace(/\D/g, "").slice(-4) || "1")
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <Button
              variant="ghost"
              size="sm"
              className="gap-2 text-muted-foreground hover:text-white hover:bg-primary transition-colors"
