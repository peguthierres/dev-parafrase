...
const mostRead = [
  { id: "0001", content: "Ser ou não ser, eis a questão.", author: "Shakespeare", views: 2340 },
  { id: "0002", content: "Só sei que nada sei.", author: "Sócrates", views: 1890 },
  { id: "0003", content: "A imaginação é mais importante que o conhecimento.", author: "Einstein", views: 1650 },
]

const mostLiked = [
  { id: "0004", content: "Seja a mudança que você quer ver no mundo.", author: "Gandhi", likes: 445 },
  {
    id: "0005",
    content: "A vida é aquilo que acontece enquanto você está ocupado fazendo outros planos.",
    author: "John Lennon",
    likes: 389,
  },
  {
    id: "0006",
    content: "O futuro pertence àqueles que acreditam na beleza de seus sonhos.",
        ...
        <CardContent className="p-4">
          <div className="w-full h-[300px] bg-muted/50 rounded-lg flex items-center justify-center">
            <div className="text-center text-muted-foreground">
              <div className="text-sm font-medium mb-1">Espaço Publicitário</div>
              <div className="text-xs">300x300 - Gerenciado pelo Admin</div>
            </div>
          </div>
        </CardContent>
      </Card>
